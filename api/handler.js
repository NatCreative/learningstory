export default async function handler(req, res) {
  ...
  // Handle home extension - generate if not provided
...
- Learning dispositions you observed (curiosity, resilience, creativity, collaboration, etc.)
...
${homeExtension ? `
Based on the provided suggestions: ${homeExtension}

Expand on these ideas and offer 3-4 simple, engaging activities that families can try at home, considering the child's developmental level.
` : `
